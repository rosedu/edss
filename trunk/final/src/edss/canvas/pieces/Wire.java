...
{
	public WirePoints points;
	public Segment selectedSegment;
	public Element line;
	public Element startPin;
	public Element endPin;
	public String idStartPin;
	public String idEndPin;
	public String idStartPiece;
	public String idEndPiece;
	...
	public Wire(CanvasImpl canvas, List<? extends Point> pointList, String id)
	{
		...
		points.pointList = (LinkedList<MyPoint>) pointList;// (LinkedList<MyPoint>)
